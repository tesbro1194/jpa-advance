...
public class ManyToOneTest {
    ...
    void test1() {
        ...
        userRepository.save(user);  // 이 부분이 주석처리되면 오류 발생. object references an unsaved transient instance - save the transient instance before flushing
    ...
    void test5() {
        Food food = foodRepository.findById(3L).orElseThrow(NullPointerException::new);
        // 음식 정보 조회
    ...
    void test6() {
        User user = userRepository.findById(4L).orElseThrow(NullPointerException::new);
        // 고객 정보 조회
